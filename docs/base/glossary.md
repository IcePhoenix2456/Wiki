...
## Железо
- Erista(Эриста) - обозначение ранней ревизии чипов Tegra X1, установленных в Nintendo Switch первой версии. Часть этих чипов имеет программную уязвимость, позволяющую прошить консоль без использования мод-чипа. Проверить вашу консоль на программную уязвимость можно на [сайте](https://ismyswitchpatched.com/) введя ваш серийный номер консоли. Консоль также можно прошить с помощью мод-чипа.
