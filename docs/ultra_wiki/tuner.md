...
- **Other**
    ...
    - **Atmosphere Patches**
        - **Memory Patch** - позволяют увеличить доступное количество оперативной памяти, полезно для HOS 20 и выше. Есть три варианта stock, +1.85mb, +40mb. После включения патча +40mb у вас вновь заработают игры, которые не запускались с LFS модами. Игры, которые используют браузер, будут вылетать.
